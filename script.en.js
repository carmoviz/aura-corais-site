...
const CONFIG = {
  ...
  txt: {
    ...
    newsInvalido: 'Please enter a valid e-mail.',
    newsOk: 'Done! You are on the updates list.',
    newsErro: 'We could not sign you up right now. Please try again in a moment.'
  }
};
